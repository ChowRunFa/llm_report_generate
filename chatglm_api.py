...
from Utils.chatglm_utils import process_response, generate_chatglm3, generate_stream_chatglm3
...
if __name__ == "__main__":
    tokenizer = AutoTokenizer.from_pretrained("E:\LargeFiles\Models\chatglm3-6b", trust_remote_code=True)
